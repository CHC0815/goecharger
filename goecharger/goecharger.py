...
class GoeChargerStatusMapper:
    ...
    def mapApiStatusResponse(self, status):
        ...
        return ({
            ...
            'eca': status.get("eca", "") / 10.0,
            'ecr': status.get("ecr", "") / 10.0,
            'ecd': status.get("ecd", "") / 10.0,
            'ec4': status.get("ec4", "") / 10.0,
            'ec5': status.get("ec5", "") / 10.0,
            'ec6': status.get("ec6", "") / 10.0,
            'ec7': status.get("ec7", "") / 10.0,
            'ec8': status.get("ec8", "") / 10.0,
            'ec9': status.get("ec9", "") / 10.0,
            'ec1': status.get("ec1", "") / 10.0,
            'rca': status.get("rca", ""),
            'rcr': status.get("rcr", ""),
            'rcd': status.get("rcd", ""),
            'rc4': status.get("rc4", ""),
